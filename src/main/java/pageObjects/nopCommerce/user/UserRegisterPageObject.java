...
public class UserRegisterPageObject extends BasePage {
	...
	public String getErrorExistingEmailMessage() {
		waitForElementVisible(driver, RegisterPageUI.REGISTER_EXISTING_EMAIL);
		return getElementText(driver, RegisterPageUI.REGISTER_EXISTING_EMAIL);
	}
