...
public class BaseTest {
	...
	protected WebDriver getBrowserDriver(String browserName) {
		...
		System.out.println("Run on: " + browserList);
	...
	// Demo Level 22 - with Java Owner library
	protected WebDriver getBrowserAndappUrlDriver(String browserName, String appUrl) {
		BrowserList browserList = BrowserList.valueOf(browserName.toUpperCase());
		System.out.println("Run on browserList: " + browserList);
		System.out.println("Run on appUrl: " + appUrl);
		if (browserList == BrowserList.FIREFOX) {
			WebDriverManager.firefoxdriver().setup();
			FirefoxOptions options = new FirefoxOptions();
	...
	// Use func: getEnvironmentUrl 
	protected WebDriver getBrowserDriver(String browserName, String environmentName) {
		BrowserList browserList = BrowserList.valueOf(browserName.toUpperCase());
		System.out.println("Run on browserList: " + browserList);
		System.out.println("Run on environmentName: " + environmentName);
		if (browserList == BrowserList.FIREFOX) {
			WebDriverManager.firefoxdriver().setup();
			FirefoxOptions options = new FirefoxOptions();
			options.setAcceptInsecureCerts(true);
