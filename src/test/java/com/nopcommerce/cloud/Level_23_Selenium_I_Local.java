...
public class Level_23_Selenium_I_Local extends BaseTest {
	...
	public void beforeClass(String browserName, String appUrl) {
		...
		firstName = userData.getFirstName() + "Selenium Local";
		lastName = userData.getLastName();
		emailAddress = userData.getEmailAddress() + generateFakeNumber() + "@seleniumlocal.com";
