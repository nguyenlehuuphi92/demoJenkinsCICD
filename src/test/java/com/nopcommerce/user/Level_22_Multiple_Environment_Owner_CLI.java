...
public class Level_22_Multiple_Environment_Owner_CLI extends BaseTest {
	...
	public void beforeClass(String browserName) {
		...
		driver = getBrowserAndappUrlDriver(browserName, environment.appUrl());
		...
		firstName = userData.getFirstName() + " JavaOwner";
